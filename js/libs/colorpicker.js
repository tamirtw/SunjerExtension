...
(function ($) {
	var ColorPicker = function () {
		var
			...
			charMin = 65,
			visible,
			tpl = '<div class="sunjer_colorpicker"> \
			<div class="sunjer_colorpicker_color"> \
			<div><div></div></div> \
			</div> \
			<div class="sunjer_colorpicker_hue"><div> \
			</div> \
			</div> \
			</div>',
			...
			init: function (opt) {
				...
				return this.each(function () {
					if (!$(this).data('colorpickerId')) {
						...
						options.selector = cal.find('div.sunjer_colorpicker_color').bind('mousedown', downSelector);
						options.selectorIndic = options.selector.find('div div');
						options.el = this;
						options.hue = cal.find('div.sunjer_colorpicker_hue div');
						cal.find('div.sunjer_colorpicker_hue').bind('mousedown', downHue);
